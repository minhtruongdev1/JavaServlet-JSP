...
<div class="wrapper">
  ...
  <footer class="main-footer">
			<strong>Copyright &copy; 2002-2022 <a
				href="https://www.facebook.com/profile.php?id=100017257351827">Le Minh Truong</a>
...
<script>
	...
	$('#submitBtn').click(function(){
		...
		if (isEdit == 'true'){
			url = '/Java4Final/admin/video?action=edit&href=' + hrefOrigin;
		} else{
			url = '/Java4Final/admin/video?action=add';
		}

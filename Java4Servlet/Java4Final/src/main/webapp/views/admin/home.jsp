		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="index" class="d-block">${sessionScope.currentUser.username}</a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="admin/user?action=viewUser" class="nav-link">
								<i class="nav-icon fas fa-tachometer-alt"></i>
								<p>
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="admin/user?action=viewUser"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Overview User</p>
								</a></li>
								<li class="nav-item"><a href="admin/user?action=addUser"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Favorites Statistic</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>

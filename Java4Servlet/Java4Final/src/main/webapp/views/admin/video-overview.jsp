...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img
									src="<c:url value='/templates/admin/dist/img/user8-128x128.jpg" alt="User Avatar' />"
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<c:url value='/admin'/>" class="brand-link"> <img
				src="<c:url value='/templates/user/img/logoicon.png' />"
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="<c:url value='/admin/video?action=view'/>"
							...
							<li class="nav-item menu-open"><a href="<c:url value='/admin/user?action=viewUser'/>"
							class="nav-link active"> <i
								class="nav-icon fas fa-tachometer-alt"></i>
								<p>
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="<c:url value='/admin/user?action=viewUser'/>"
									class="nav-link active"> <i class="far fa-circle nav-icon"></i>
										<p>Overview User</p>
								</a></li>
								<li class="nav-item"><a
									href="<c:url value='/admin/user?action=addUser'/>"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td><img src="${item.poster}" width="200px"
											height="150px" /></td>
										<td>
		...
		<footer class="main-footer">
			<strong>Copyright &copy; 2002-2022 <a
				href="https://www.facebook.com/profile.php?id=100017257351827">NGUYEN
					THANH CHUNG</a>.
	...
	function deleteVideo(href){
		$.ajax({
			url: '/Java4Final/admin/video?action=delete&href=' + href
		}).then(function(data) {
			window.location.href = "http://localhost:8080/Java4Final/admin/video?action=view";
		}).fail(function(error) {
